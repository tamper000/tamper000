...
- **Инструменты**: Изучаю новые библиотеки и инструменты для разработки
...
### [Task1](https://github.com/tamper000/task1) - Задачка с собеса
> _Интересная задача с собеса. Реализация брокера очередей через RESTAPI_

---

## ✅ Чему я научился

- Внедрение базовых метрик и создание своих. Настройка логгирования
- Узнал ошибки (Такие как Thundering Nerd), которые могут возникнуть при разработке Backend приложений
- Создание Dockerfile, особенности при их создании.
